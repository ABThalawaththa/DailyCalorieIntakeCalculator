...
public class CalorieRecordAdapter extends RecyclerView.Adapter {
        ...
        viewHolder.bt_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference databaseReference =
                        FirebaseDatabase.getInstance().getReference("Calorie Records").child(user.getUid()).child(daily_calorie_record.getRecordId());
  ...
  /*  private void goToUpdate(Daily_Calorie_Record daily_calorie_record){
        Intent intent = new Intent(CalorieRecordAdapter.this,UpdateCalorieIntakeRecord.class);
    }*/
    @Override
